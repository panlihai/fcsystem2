...
export class ManyComponent extends ComponentParent {
  ...
  //只读
  readonlyview: string = `
  <fc-many [fcLabel]="'只读'" [(ngModel)]="manyValue"  [fcOption]="manyOptionsDisabled" fcReadonly="Y"></fc-many>
  `
  ...
  //禁用状态
  disabledview: string = `
  <fc-any [fcLabel]="'禁用'"  fcDisabled="Y" [(ngModel)]="anyValue" [fcOption]="anyOptionsDisabled" ></fc-any>
  `
  //是否带搜索view
  searchview: string  = `
