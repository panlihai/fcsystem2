...
import { LogService } from 'fccore2/services/log.service';
@Component({
  selector: 'tree',
...
export class TreeComponent extends ComponentParent {
  //树事件view
  treeeview: string = `
  <fc-tree [(ngModel)]="treeSelectObj" [fcCheckedKeys]="['SYS']" [fcOption]="treeOptions" (fcEvent)=" treeEvent($event);"></fc-tree>
  `
   // 基本basicjs
   basicjs: string = `
   import { Component, OnInit } from '@angular/core';
