...
export class ComboComponent extends ComponentParent {
  ...
  comboOptions1: any[] = [{ icon: '', label: 'A', value: 'a' }, { icon: '', label: 'B', value: 'b' }, { icon: '', label: 'C', value: 'c' },
  { icon: '', label: 'A1', value: 'a' }, { icon: '', label: 'B1', value: 'b' }, { icon: '', label: 'C1', value: 'c' },
  { icon: '', label: 'A2', value: 'a' }, { icon: '', label: 'B2', value: 'b' }, { icon: '', label: 'C2', value: 'c' },
  { icon: '', label: 'A3', value: 'a' }, { icon: '', label: 'B3', value: 'b' }, { icon: '', label: 'C3', value: 'c' },
  { icon: '', label: 'A4', value: 'a' }, { icon: '', label: 'B4', value: 'b' }, { icon: '', label: 'C4', value: 'c' },
  { icon: '', label: 'A5', value: 'a' }, { icon: '', label: 'B5', value: 'b' }, { icon: '', label: 'C5', value: 'c' },
  { icon: '', label: 'A6', value: 'a' }, { icon: '', label: 'B6', value: 'b' }, { icon: '', label: 'C6', value: 'c' }];
  comboOptionsDisabled: any[] = [{ icon: '', label: 'A', value: 'a' }, { icon: '', label: 'B', value: 'b' },
  { icon: '', label: 'C', value: 'c', disabled: true }];
  constructor(public mainService: ComponentService) {
    super('FCCOMBO', mainService);
    let _condition={
      WHERE:"{APPID:{like:'%SYS%'}}"
    }
  ...
  //只读
  readonlyview: string = `
   <fc-combo [fcLabel]="'只读'" [(ngModel)]="comboValue" [fcOption]="comboOptionsDisabled" fcReadonly="Y"></fc-combo>
   `
  //单独禁用
  ...
  //禁用状态
  disabledview: string = `
    <fc-combo [fcLabel]="'禁用'" [(ngModel)]="comboValue" [fcOption]="comboOptionsDisabled"  fcDisabled="Y"></fc-combo>
    `
  //是否带搜索view
  searchview: string = `
  ...
  clearjs: string = `
   ...
   comboEvent(event:FCEVENT){
    switch(event.eventName){
      case 'clear':
      this.mainService.providers.msgService.warm('已经清除了内容');
      break;
    }
  }
   `;
