...
export class SwitchComponent extends ComponentParent {
  ...
  */
  ...
  //文案展示
  textview: string = `
    <fc-switch [fcLabel]="'文案显示'" [(ngModel)]="abc" (ngModelChange)="switchEvent($event)" fcCheckValue="Y" [fcShowText]="'Y'" fcCheckedChildren="0" fcUnCheckedChildren="1" fcOption='[{"label":"是","value":"Y"},{"label":"否","value":"N"}]'></fc-switch>
    `
  //图标展示
  iconview: string = `
