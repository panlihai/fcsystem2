...
export class UploadComponent extends ComponentParent {
  ...
  //只读
  readonlyview: string = `
  <fc-upload  [fcLabel]="'只读'" fcReadonly="Y" (fcEvent)="fileEvent($event)" [fcOption]="{FILETYPE:'PIC',SOURCEID:'dd90c093667947c4a4265e001602b9cd',SOURCEAID:'SYSAPP','SOURCEFIELD':'APPURL','RESTITLE':''}"></fc-upload>
  `
  //禁用
 disabledview: string = `
 <fc-upload  [fcLabel]="'只读'" [fcListType]="'picture-card'" (fcEvent)="fileEvent($event)" [fcOption]="{FILETYPE:'PIC',SOURCEID:'dd90c093667947c4a4265e001602b9cd',SOURCEAID:'SYSAPP','SOURCEFIELD':'APPURL','RESTITLE':''}" fcDisabled="Y"></fc-upload>
 `
 //listview
 listview: string = `
