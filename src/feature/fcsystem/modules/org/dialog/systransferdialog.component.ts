...
@Component({
    ...
    <fc-layoutpanel>
        ...
        <fc-layoutcol fccontent fcSpans="1,0">
            <fc-textarea fccontent1 fcCol="1" fcLabel="撤销原因" [(ngModel)]="mainObj.GRPCODE" [fcAppid]="appId" fcFieldCode="GRPCODE" name="REMARK"
        ...
        <div fccontent class="sys-title-container">
            <fc-title fcLabel="变更前上级单位" class="sys-flex-title" fcBorder="bottom" fcWidth="96%"  fcHasLine="N"></fc-title>
        </div>
        ...
        <div fccontent class="sys-title-container">
            <fc-title fcLabel="变更后上级单位" class="sys-flex-title" fcBorder="bottom" fcWidth="96%"  fcHasLine="N"></fc-title>
        </div>
        <fc-layoutrow fccontent fcSpan="200">
            <div style="height:190px;" fccontent1>
                <fc-listdata  [fcAppid]="appId" [fcOption]="listOptions" (fcEvent)="componentEvents('listdataEvent',$event)"></fc-listdata>
...
export class SystransferdialogComponent extends ParentEditComponent {
    mainObj: any = {};
    codeValue: any;
