  ...
  <fc-layoutpanel class="sysappadd sys-card-pannel">
    ...
    <div fccontent class="sys-sppmodify-content">
      ...
      <fc-layoutcol fcSpans="1,1" fccontent1>  
        <fc-combo [fcLabel]="'产品'" [fcOption]="productOption"   fccontent1 (ngModelChange)="chooseProduct($event)">
        </fc-combo>
        <fc-combo [fcLabel]="'数据源'" [fcOption]="datasourceOption"   fccontent2 (ngModelChange)="chooseDatasource($event)">
        </fc-combo>    
      </fc-layoutcol>
