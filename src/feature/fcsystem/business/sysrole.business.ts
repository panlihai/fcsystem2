...
export class SysroleBusiness extends ParentBusiness {
  ...
  static saveOrUpdateRole(obj: any): Observable<any> {
    if (obj.ID === undefined||obj.ID=='') {
      ...
      //修改时传where条件,数据库根据id修改数据
      obj.WHERE="{ID:{eq:'" + obj.ID + "'}}";
  ...
  */
   ...
   */
  static saveRoleUser(sysuserList: any[], role: Sysrole):Observable<any> {
    ...
    return SystemBusiness.appService.saveObject("SYSROLEUSER",roleUserList);
  }
  /**
