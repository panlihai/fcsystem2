...
export class CheckComponent extends ComponentParent {
  ...
  //只读view
  readonlyview: string = `
  <fc-check [fcLabel]="'只读'"  fcReadonly="Y" [(ngModel)]="checkValue" [fcOption]="checkOptionsreadonly"></fc-check>
  `
  //单独禁用
  ...
  //禁用状态
  disabledview: string = `
  <fc-check [fcLabel]="'禁用'"   fcDisabled="Y" [(ngModel)]="checkValue" [fcOption]="checkOptionsDisabled"></fc-check>
  `
  //基本用法
  basicjs:string = `
