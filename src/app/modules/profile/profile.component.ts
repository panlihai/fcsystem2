...
@Component({
    ...
    .personel{
      ...
      :host ::ng-deep .left>.fc-layoutrow{
        min-height:450px;
      }
      ...
      ::ng-deep .profile .sysprofile-tab,::ng-deep .profile nz-tab{
        height:100%;
      }
      ::ng-deep .profile .ant-tabs-content{
        height: calc(100% - 61px);
      }
      ::ng-deep .sysprofile-tab .ant-tabs-tabpane,
      ::ng-deep .sysprofile-tab .ant-tabs-tabpane>div,
    ...
    .sysprofile-tab .ant-tabs-tabpane .sysprofile-content{
...
export class ProfileComponent extends ParentlistComponent {
    ...
    switch (event.eventName) {
      case 'select'://选中一条
       CommonService.event('selectedMenu', {
          ...
          PID: FCCONFIG.pid, MENUTYPE: 'INURL', MENUNAME: '待办任务', MENUICON: 'fc-icon-bgefficiency'
        });
        break;
    ...
    switch (event.eventName) {
      case 'select'://选中一条
        CommonService.event('selectedMenu', {
          ...
          PID: FCCONFIG.pid, MENUTYPE: 'INURL', MENUNAME: '访问日志', MENUICON: 'fc-icon-bgefficiency'
        });
        break;
    }
  }
    ...
    switch (event.eventName) {
      case 'select'://选中一条
        CommonService.event('selectedMenu', {
          ...
          PID: FCCONFIG.pid, MENUTYPE: 'INURL', MENUNAME: '消息详情', MENUICON: 'fc-icon-bgefficiency'
        });
  ...
  addNavLinkTag(ontentTpl_navLink,footerTpl_navLink){
  }
