...
export default class HomeBusiness extends ParentBusiness {
    ...
    static assignmentMessage(msg: any): Observable<any> {
        ...
        let menu = this.findMenuByRouter( SystemBusiness.menus , sourceId.toLowerCase() + 'Detail');
        if (menu) {
    ...
    static sysannouncementrouter(msg: any) {
        let menu = LayoutBusiness.findMenuByRouter( SystemBusiness.menus , 'sysannouncementDetail');
        if (menu) {
            menu["param"] = msg;
            CommonService.event("selectedMenu", menu);
        } else {
    ...
    static sysassignmentrouter(msg: any) {
        let menu = LayoutBusiness.findMenuByRouter( SystemBusiness.menus , 'sysassignmentDetail');
        if (menu) {
            menu["param"] = msg;
            CommonService.event("selectedMenu", menu);
        } else {
   ...
   */
    ...
    */
    static navToByMenuId(menuId: any) {
        let menu = this.findMenuByRouter( SystemBusiness.menus , menuId);
        if (menu) {
            CommonService.event("selectedMenu", menu);
        } else {
